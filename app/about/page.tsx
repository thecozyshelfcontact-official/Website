...
export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <h1 className="text-4xl font-bold mb-6">About DealRadar</h1>
      <div className="prose dark:prose-invert prose-lg">
        <p>DealRadar is your trusted source for honest product reviews, curated deals, and buying guides.</p>
