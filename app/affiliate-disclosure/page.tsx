  ...
  return (
    <div className="section-cozy">
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="editorial-title text-4xl md:text-5xl mb-6">Affiliate Disclosure</h1>
        <div className="prose-cozy bg-brand-card border border-cozy-200 rounded-3xl p-6 md:p-10 shadow-cozy">
          ...
          <p>The Cozy Shelf participates in various affiliate programs, including Amazon Associates and others. When you click product links and make a purchase, we may earn a small commission at no additional cost to you.</p>
